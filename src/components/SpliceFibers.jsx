...
const SpliceFibers = ({ l, dataFcs, updateState, spliceFibersPoint, cables, getSpDataRequest, onClose, connections }) => {
  ...
  async function onSaveChanges() {
    ...
    const res = await logAddInfo(spliceFibersPoint.name_id, l.Fiber_Assignment_Changed, l.State_changed_to);
